document.addEventListener('DOMContentLoaded', () => {
  ...
  lista.addEventListener('click', async (e) => {
    ...
    if (e.target.classList.contains('salvar')) {
      ...
      // Reaproveita os dados do formulário (exceto a senha que pode estar vazia)
      const dados = {
        nome: form.nome.value,
        cpf: form.cpf.value,
        email: form.email.value,
      ...
      carregarUsuarios(); // Atualiza a lista depois de salvar
    }
    ...
    if (e.target.classList.contains('cancelar')) {
      ...
      carregarUsuarios(); // Atualiza a lista para reverter as edições
    }
